...
Small-Moderate deviation × Low-Moderate rigidity × Low interpretation × Low-Moderate self-relevance \= **Small Topographical Distortion**
...
*This is where the formula becomes explosive.*

* "That sound might be my child crying" → immediate cascade of interpretations:  
  * Hungry? (Minor, but still distressing to them)  
  * Scared? (Moderate—psychological distress)  
  * Hurt? (Major—physical harm)  
  * In danger? (Catastrophic—immediate threat)  
...
Small deviation × MAXIMUM rigidity × MASSIVE interpretation × MAXIMUM self-relevance \= **OVERWHELMING Topographical Distortion**
...
Large deviation × Low rigidity × Minimal interpretation × Near-zero self-relevance \= **Small Topographical Distortion**
...
Deviation × maximum rigidity × massive interpretation × maximum self-relevance \= instant large distortion.
...
**LoS explains:** The cry creates larger topographical distortion (even though it's weaker informationally) because self-relevance multiplies the deviation's phenomenal impact. Prediction error is cognitively neutral; topographical distortion is phenomenally valenced.
